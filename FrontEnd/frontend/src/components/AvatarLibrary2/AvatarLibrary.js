...
const AvatarComponent = ({ onImageSelect, profileImage , value }) => {
  ...
  useEffect(() => {
    // Update selectedImage when the value prop changes
  ...
  return (
    <div className="avatar-upload">
      ...
      <div className="avatar-preview">
        <div
          className={`imagePreview ${selectedImage || profileImage ? '' : 'active'}`}
